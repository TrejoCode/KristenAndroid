...
public class PreferencesManager {
    ...
    public void setContext(WeakReference<Context> contextWeakReference) {
        ...
        mSharedPref = contextWeakReference.get()
                .getSharedPreferences(SessionManager.PREFERENCE_FILE, Context.MODE_PRIVATE);
    }
    ...
    public SessionLoaded loadSession() {
        ...
        String session = mSharedPref.getString(SessionManager.SESSION_KEY, "");
        String pass = mSharedPref.getString(SessionManager.PASS_KEY, "");
        if (!session.equals("")) {
     ...
     */
    public void saveNotificationsPreference(boolean general, boolean career) {
        SharedPreferences.Editor editor = mSharedPref.edit();
